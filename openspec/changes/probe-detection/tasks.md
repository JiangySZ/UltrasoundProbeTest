...
- [ ] 4.1.2 创建PortScanner类
- [ ] 4.1.3 实现scan方法遍历A/B/C/D
- [ ] 4.1.4 实现checkPort单个端口检查

### 4.2 实现探头ID读取功能

- [ ] 4.2.1 创建ProbeReader类
- [ ] 4.2.2 实现readId方法
- [ ] 4.2.3 实现ID格式验证
- [ ] 4.2.4 实现ID回读校验
...
- [ ] 4.3.1 创建ProbeInfo结构体
  - port, id, model, config, state
- [ ] 4.3.2 实现isKnownProbe方法
- [ ] 4.3.3 实现matchConfig自动匹配
- [ ] 4.3.4 加载匹配的配置
...
- [ ] 4.5.1 创建ScriptLoader类
- [ ] 4.5.2 实现activateProbe方法
- [ ] 4.5.3 实现激活状态管理
- [ ] 4.5.4 实现激活结果反馈
